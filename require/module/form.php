                        ...
                        <div class="col-md-12 text-center p-1">
                                <?php if (isset($_GET['search'])) { ?>
                                        <p class="fs-12 lh-1-1"><b>Search View :</b> <span class="text-grey">Search Data :</span> <?php echo $_GET['search_type']; ?> | <span class="text-grey">Search Value:</span> <?php echo $_GET['search_value']; ?>
                                                <a href="index.php" class="text-right m-l-15"><span class="text-danger"><i class="fa fa-times"></i>Clear Search</span></a>
                                        </p>
                                <?php } ?>
                        </div>
                </div>
...
function SelectOptions($SQL, $fielvalue, $columnname, $selected = null, $default = true)
{
        global $DBConnection;
        $Sql = "$SQL";
...
function SuggestOptions($data, $default = null)
{
        $RegOptions = $data;
        $Count = 0;
        foreach ($RegOptions as $key => $options) {
        ...
        ?>
                <option value="<?php echo $key; ?>" <?php echo $selected; ?>><?php echo $options; ?></option>
        <?php }
}
...
//function Input fileds
function Input($attributes)
{
?>
        <input <?php LOOP_TagsAttributes($attributes); ?>>
<?php
}
