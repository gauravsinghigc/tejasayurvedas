        ...
        <div id="page-content">
          ...
          <div class="panel">
            <div class="panel-body">
              <div class="row">
                <div class="col-md-12">
                  <h4 class="app-heading">Profile</h4>
                </div>
              </div>
              <br>
              <div class="row">
                <div class="col-md-8 col-lg-8 col-sm-7 col-12">
                  <form class="form" action="../../controller/authcontroller.php" method="POST">
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <br>
                        <button type="Submit" name="UpdateProfile" class="btn btn-md app-btn">Update Details</button>
                      </div>
                    </div>
                  </form>
                  <hr>
                  <form class="form" action="../../controller/authcontroller.php" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <br>
                        <button type="Submit" id="passbtn" name="UpdatePassword" class="btn btn-md app-btn disabled">Update Password</button>
                      </div>
                    </div>
                  </form>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-5 col-12">
                  <div class="shadow-lg br10 p-2 border-success">
                    <div class="br10 app-bg-light p-3 text-center">
                      <center>
                        <img src="<?php echo STORAGE_URL_U; ?>/img/profile/<?php echo LOGIN_UserProfileImage; ?>" class="w-25 mx-auto d-block rounded config-logo" style="border-radius:100% !important;">
                      </center>
