                  ...
                  <div class="table-responsive">
                    <table class="table table-striped" id="demo-dt-basic">
                      ...
                      if (isset($_GET['search']) == true) {
                        ...
                        $DB_DATA_FETCH = FetchConvertIntoArray("SELECT * FROM orders where orders.$search_type='$searchvalue' and OrderStatus='1' ORDER BY OrderId DESC", true);
                      } else {
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo DOMAIN; ?>/admin/orders/view.php?orderid=<?php echo SECURE($DATA->OrderId, "e"); ?>" class="text-primary text-decoration-underline">
                                <?php echo $DATA->CustomOrderId; ?> <span class="text-grey text-decoration-none fs-12"><i><?php echo $DATA->OrderReferenceid; ?></i></span>
                              </a>
                            </td>
