...
if (CONTROL_NOTIFICATION == "true") {
  ...
  <?php if (isset($_SESSION['success'])) { ?>
    <div class="text-black border-circle mb-4 p-1 notification-box" id="MsgArea1">
  ...
  <?php unset($_SESSION['success']);
    ...
    <div class="text-black border-circle mb-4 p-1 notification-box" id="MsgArea2">
      <?php if (CONTROL_NOTIFICATION_SOUND == "true") { ?>
        <audio controls autoplay hidden="">
    ...
    <div class="text-black border-circle mb-4 p-1 notification-box" id="MsgArea3">
      <?php if (CONTROL_NOTIFICATION_SOUND == "true") { ?>
        <audio controls autoplay hidden="">
    ...
    <div class="text-black border-circle mb-4 p-1 notification-box" id="MsgArea4">
      <?php if (CONTROL_NOTIFICATION_SOUND == "true") { ?>
        <audio controls autoplay hidden="">
