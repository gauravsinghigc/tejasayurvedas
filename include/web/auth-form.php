  ...
  <form action="<?php echo DOMAIN; ?>/controller/authcontroller.php" method="POST">
   ...
   <div class="row">
    ...
    <div class="form-group col-lg-8 col-md-8 col-12 text-left">
     <label class="text-left">Enter Your Email ID</label>
     <input type="email" name="CustomerEmailid" class="form-control p-2r" required="" placeholder="abc@domain.ext" value="">
    </div>
    <div class="form-group col-lg-8 col-md-8 col-12 text-left">
